...
import { collection, deleteDoc, doc, getDoc, getDocs, query, setDoc } from 'firebase/firestore' // Firestore functions
import { Box, Typography, Button, Modal, Stack, TextField, Container, Paper } from "@mui/material";
  ...
  return (
    <Container>
      ...
      >
        ...
        <Paper elevation={3} sx={{ width: '800px', padding: 2, mt: 2 }}>
          <Box
            width="800px"
            height="100px"
            bgcolor="#ADD8E6"
